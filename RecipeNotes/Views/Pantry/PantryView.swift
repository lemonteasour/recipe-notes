...
struct PantryView: View {
    ...
    private func handleDrop(droppedIds: [String], to category: PantryCategory?) {
        for droppedIdString in droppedIds {
            guard let droppedId = UUID(uuidString: droppedIdString) else { continue }
